...
portable_init(core_portable *p, int *argc, char *argv[])
{
    ...
    /* Set rc_hclk and rc32k trim value */
    rom_hw_pmu_set_rc_hclk_tune(0x56);
    rom_hw_pmu_set_rc_lclk_tune(0xA9);
    ...
    rom_hal_pmu_set_sys_clk_src(EN_SYS_CLK_DCXO16M, DCXO_HCLK_STABLE_TIME_2500US);

    // Log init
#if APP_DEBUG_ENABLED
    app_debug_init(GPIO_PORT_MP_APP_DEBUG_TX, GPIO_PIN_MP_APP_DEBUG_TX, UART_HANDLE_MP_APP_DEBUG, UART_BPS_MP_APP_DEBUG, NULL);
    ee_printf("\nCoreMark(cm33) start to work.\n");
#endif
