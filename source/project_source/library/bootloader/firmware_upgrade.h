...
typedef enum
{
    ...
    EN_FIRM_CMD_FLASH_INIT          =   0x09,
    EN_FIRM_CMD_DOWNBIN_END         =   0x0F,
    EN_FIRM_CMD_FLASH_MODE_CFG      =   0x10,
    EN_FIRM_CMD_READ_FLASH_STA      =   0x11,
    EN_FIRM_CMD_WRITE_FLASH_STA     =   0x12,
    EN_FIRM_CMD_SET_FLASH_DIV       =   0x13,
    EN_FIRM_CMD_READ_SEC_REG        =   0x14,
    EN_FIRM_CMD_WRITE_SEC_REG       =   0x15,
