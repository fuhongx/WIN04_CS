...
#ifndef __QMX_INTC_H__
#define __QMX_INTC_H__
 ...
 */
void qmx_register_irq_handler(IRQn_Type irq_num, irq_handler_t handler);
 ...
 * @param irq_num 中断号，参考IRQn_Type枚举
 */
void qmx_unregister_irq_handler(IRQn_Type irq_num);

#endif  /* __QMX_INTC_H__ */
