...
typedef struct
{
    qmx_rf_txdac_gain_e txdac_gain; // refer to qmx_rf_txdac_gain_e
    qmx_rf_txlpf_gain_e txlpf_gain; // refer to qmx_rf_txlpf_gain_e
    qmx_rf_txlpf_bw_e txlpf_bw;     // refer to qmx_rf_txlpf_bw_e
    qmx_rf_txlpf_vcm_e txlpf_vcm;   // refer to qmx_rf_txlpf_vcm_e
    qmx_rf_txlpf_bias_e txlpf_bias_op1; // refer to qmx_rf_txlpf_bias_e
    qmx_rf_txlpf_bias_e txlpf_bias_op2; // refer to qmx_rf_txlpf_bias_e
    qmx_rf_txlpf_bias_e txlpf_bias_op3; // refer to qmx_rf_txlpf_bias_e
    qmx_rf_txlpf_bias_e txlpf_bias_op4; // refer to qmx_rf_txlpf_bias_e
    uint8_t txdac_clk_phase;        // 0:输入CLK取反，内部采用下降沿取输入code;
                                    // 1:输入CLK不取反，内部采用上升沿取输入code;
} qmx_rf_tx_dac_lpf_ctrl_t;
