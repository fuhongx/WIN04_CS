...
#ifndef __QMX_HAL_GPIO_H__
#define __QMX_HAL_GPIO_H__
...
#define QMX_HAL_LPIO_MASK         (0xC0000)
 ...
 */
void qmx_hal_gpio_set_direction(hal_gpio_pin_e pin, hal_gpio_direction_e direction);
 ...
 */
void qmx_hal_gpio_set_input_filter(uint32_t sample_cycle);
 ...
 */
hal_gpio_level_e qmx_hal_gpio_get_value(hal_gpio_pin_e pin);
 ...
 */
void qmx_hal_gpio_set_value(hal_gpio_pin_e pin, hal_gpio_level_e level);
 ...
 */
void qmx_hal_gpio_set_interrupt(hal_gpio_pin_e pin, hal_gpio_intr_e interrupt);
 ...
 */
void qmx_hal_gpio_enable_interrupt(hal_gpio_pin_e pin, bool enable);
 ...
 * @param pin GPIO pin number, GPIO引脚编号, see hal_gpio_pin_e enum for details
 */
void qmx_hal_gpio_clear_pin_interrupt(hal_gpio_pin_e pin);
 ...
 */
hal_gpio_intr_sta_e qmx_hal_gpio_get_pin_interrupt_sta(hal_gpio_pin_e pin);

/**
 * @brief Clear all GPIO interrupts, 清除所有GPIO引脚中断标志
 */
void qmx_hal_gpio_clear_all_interrupts(void);
 ...
 */
uint32_t qmx_hal_gpio_get_all_interrupts(void);
 ...
 */
void qmx_hal_gpio_set_mode(hal_gpio_pin_e pin, hal_gpio_mode_e mode);
 ...
 */
void qmx_hal_gpio_set_iomux(hal_gpio_pin_e pin, hal_gpio_iomux_e iomux);
 ...
 */
void qmx_hal_lpio_set_direction(hal_gpio_pin_e pin, hal_gpio_direction_e direction);
 ...
 */
void qmx_hal_lpio_set_value(hal_gpio_pin_e pin, hal_gpio_level_e level);
 ...
 */
hal_gpio_level_e qmx_hal_lpio_get_value(hal_gpio_pin_e pin);
 ...
 */
void qmx_hal_lpio_set_mode(hal_gpio_pin_e pin, hal_gpio_mode_e mode);
 ...
 */
void qmx_hal_lpio_set_iomux(hal_gpio_pin_e pin, hal_gpio_iomux_e iomux);
 ...
 */
void qmx_hal_lpio_set_interrupt(hal_gpio_pin_e pin, hal_gpio_intr_e interrupt);
 ...
 * @param enable true to enable interrupt, false to disable interrupt, 是否使能中断，true为使能，false为禁用
 */
void qmx_hal_lpio_enable_interrupt(hal_gpio_pin_e pin, bool enable);

/**
 * @brief Clear all LPIO interrupts, 清除所有LPIO引脚中断标志
 */
void qmx_hal_lpio_clear_interrupt(void);
 ...
 */
uint32_t qmx_hal_lpio_get_interrupt_sta(void);

#ifdef __cplusplus
}
#endif

#endif  /* __QMX_HAL_GPIO_H__ */
