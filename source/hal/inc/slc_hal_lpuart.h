...
#ifndef __SLC_HAL_LPUART_H__
#define __SLC_HAL_LPUART_H__
 ...
 * @note  LPUART DMA的收发接口默认TRX fifo阈值都为1字节，需用户在slc_hal_lpuart_init时确保配置一致
 * 
 * @param lpuart    LPUART模块ID, 参考 hal_lpuart_id_e
