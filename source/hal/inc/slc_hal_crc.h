...
#ifndef __SLC_HAL_CRC_H__
#define __SLC_HAL_CRC_H__
 ...
 */
void slc_hal_crc_init(hal_crc_init_t *init);
 ...
 */
void slc_hal_crc_deinit(hal_crc_type_e crc_type);
 ...
 */
uint32_t slc_hal_crc_calculate(hal_crc_type_e crc_type, uint8_t *data, uint32_t len);
 ...
 * @note  该接口仅供快速计算CRC16使用，无需调用slc_hal_crc_init，其他CRC类型请使用slc_hal_crc_calculate接口
 ...
 * @note  该接口仅供快速计算CRC24使用，无需调用slc_hal_crc_init，其他CRC类型请使用slc_hal_crc_calculate接口
 * @param pu8Buffer Pointer to buffer.
 * @param u16Len Length of buffer.
 ...
 * @note  该接口仅供快速计算CRC32使用，无需调用slc_hal_crc_init，其他CRC类型请使用slc_hal_crc_calculate接口
 * @param pu8Buffer Pointer to buffer.
 * @param u16Len Length of buffer.
