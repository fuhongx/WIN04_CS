...
#ifndef __QMX_HAL_PWM_H__
#define __QMX_HAL_PWM_H__
 ...
 */
void qmx_hal_pwm_timer_init(hal_pwm_ch_e pwm_ch, hal_pwm_config_t *config);
 ...
 * @param pwm_ch PWM通道，具体见hal_pwm_ch_e
 */
void qmx_hal_pwm_timer_start(hal_pwm_ch_e pwm_ch);
 ...
 * @param pwm_ch PWM通道，具体见hal_pwm_ch_e
 */
void qmx_hal_pwm_timer_stop(hal_pwm_ch_e pwm_ch);
 ...
 */
uint32_t qmx_hal_pwm_timer_get_counter(hal_pwm_ch_e pwm_ch);
 ...
 * @param pwm_ch PWM通道，具体见hal_pwm_ch_e
 */
void qmx_hal_pwm_timer_enable_irq(hal_pwm_ch_e pwm_ch);
 ...
 * @param pwm_ch PWM通道，具体见hal_pwm_ch_e
 */
void qmx_hal_pwm_timer_disable_irq(hal_pwm_ch_e pwm_ch);
 ...
 */
uint32_t qmx_hal_pwm_timer_get_irq_status(void);
 ...
 */
void qmx_hal_pwm_timer_clear_irq(uint32_t status);

#ifdef __cplusplus
}
#endif

#endif  /* __QMX_HAL_PWM_H__ */
