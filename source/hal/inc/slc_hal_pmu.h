...
#ifndef __SLC_HAL_PMU_H__
#define __SLC_HAL_PMU_H__
 ...
 */
void slc_hal_pmu_set_lp_mode(hal_pmu_lp_mode lp_mode);
 ...
 */
void slc_hal_pmu_set_lp_wakeup_source(uint32_t lp_wakeup_src_msk);
 ...
 */
uint32_t slc_hal_pmu_get_wakeup_src_sta(void);
 ...
 */
void slc_hal_pmu_rf_lp_bypass(bool enable);

/**
 * @brief 系统进入shutdown模式
 * 
 */
void slc_hal_pmu_powerdown(void);
 ...
 */
void slc_hal_pmu_lpio_enable(bool enable);
 ...
 */
void slc_hal_pmu_set_boot_flag(uint8_t boot_flag);
